...
def test_example(page: Page) -> None:
    ...
    page.get_by_role("textbox", name="Search integrations").click()
    ...
    page.get_by_role("textbox", name="Ownership Report URL").fill("https://app.beeceptor.com/console/mp15fcb2b4f645b182f1")
    ...
    page.locator("div").filter(has_text=re.compile(r"^Select$")).nth(1).click()
    page.get_by_text("employeeRole").click()
    page.locator("div").filter(has_text=re.compile(r"^Select$")).nth(1).click()
