...
def _add_deploy():
    cli(["deploys", "add", "-t", "test-service", "-f", "data/run-time/deploys.json"])

def _delete_all():
    cli(["deploys", "delete-all"])
    result = cli(["deploys", "list", "-t", "test-service"])
...
def test_deploys():
    ...
    result = cli(["deploys", "add", "-t", "test-service", "-f", "data/run-time/deploys-uuid.json"])
    uuid = result['uuid']
    ...
    cli(["deploys", "update-by-uuid", "-t", "test-service", "-u", uuid, "-f", "data/run-time/deploys-update.json"])
    result = cli(["deploys", "list", "-t", "test-service"])
    ...
    cli(["deploys", "delete-by-uuid", "-t", "test-service", "-u", uuid])
    result = cli(["deploys", "list", "-t", "test-service"])
