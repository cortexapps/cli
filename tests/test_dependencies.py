...
def test():
    callerTag = "test-service-caller"
    calleeTag = "test-service-callee"

    cli(["catalog", "create", "-f", "data/run-time/test-service-caller.yaml"])
    cli(["catalog", "create", "-f", "data/run-time/test-service-callee.yaml"])
    ...
    result = cli(["dependencies", "get", "-r", "test-service-caller", "-e", "test-service-callee", "-m", "GET", "-p", "/api/v1/github/configurations"])
    ...
    cli(["dependencies", "get", "-r", "test-service-caller", "-e", "test-service-callee", "-m", "GET", "-p", "/api/v1/github/configurations"])

    result = cli(["dependencies", "get-all", "-r", "test-service-caller", "-o"])
    ...
    cli(["dependencies", "delete", "-r", "test-service-caller", "-e", "test-service-callee", "-m", "GET", "-p", "/api/v1/audit-logs"])
    cli(["dependencies", "add-in-bulk", "-f", "data/run-time/dependencies-bulk.json"])
    cli(["dependencies", "delete-in-bulk", "-f", "data/run-time/dependencies-bulk.json"])
    cli(["dependencies", "delete-all", "-r", "test-service-caller"])
