...
app = typer.Typer(help="Opsgenie commands", no_args_is_help=True)

@app.command()
def add(
    ctx: typer.Context,
    api_token: str = typer.Option(None, "--api-token", "-at", help="API token"),
    is_eu: bool = typer.Option(False, "--is-eu", "-eu", help="If the Opsgenie instance is in the EU region"),
    ...
    r = client.post("api/v1/opsgenie/configuration", data=data)
    print_json(data=r)
...
def get(ctx: typer.Context):
    ...
    """
    client = ctx.obj["client"]
    r = client.get("api/v1/opsgenie/default-configuration")
    print_json(data=r)
...
def update(
    ...
    r = client.put("api/v1/opsgenie/configuration", data=data)
    print_json(data=r)
...
def validate(ctx: typer.Context):
    ...
    """
    client = ctx.obj["client"]
    r = client.post("api/v1/opsgenie/configuration/validate")
    print_json(data=r)
...
def delete(ctx: typer.Context):
    ...
    """
    client = ctx.obj["client"]
    r = client.delete("api/v1/opsgenie/configurations")
    print_json(data=r)
