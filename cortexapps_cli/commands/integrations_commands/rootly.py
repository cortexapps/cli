...
app = typer.Typer(help="Rootly commands", no_args_is_help=True)
...
def add(
    ...
    r = client.post("api/v1/rootly/configuration", data=data)
    print_json(data=r)
...
def delete(
    ...
    r = client.delete("api/v1/rootly/configuration/" + alias)
    print_json(data=r)
...
def delete_all(
    ...
    r = client.delete("api/v1/rootly/configurations")
    print_json(data=r)
...
def get(
    ...
    r = client.get("api/v1/rootly/configuration/" + alias)
    print_json(data=r)
...
def list(
    ...
    r = client.get("api/v1/rootly/configurations")
    print_json(data=r)
...
def get_default(
    ...
    r = client.get("api/v1/rootly/default-configuration")
    print_json(data=r)
...
def update(
    ...
    r = client.put("api/v1/rootly/configuration/" + alias, data=data)
    print_json(data=r)
...
def validate(
    ...
    r = client.post("api/v1/rootly/configuration/validate/" + alias)
    print_json(data=r)
...
def validate_all(
    ...
    r = client.post("api/v1/rootly/configuration/validate")
    print_json(data=r)
