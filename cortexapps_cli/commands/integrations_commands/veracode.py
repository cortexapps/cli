...
app = typer.Typer(help="Veracode commands", no_args_is_help=True)

@app.command()
def add(
    ctx: typer.Context,
    api_key: str = typer.Option(None, "--api-key", "-api", help="API key"),
    key_id: str = typer.Option(None, "--key-id", "-ki", help="Key ID"),
    ...
    if file_input:
        if api_key or key_id or region:
    ...
    r = client.post("api/v1/veracode/configuration", data=data)
    print_json(data=r)
...
def get(ctx: typer.Context):
    ...
    """
    client = ctx.obj["client"]
    r = client.get("api/v1/veracode/default-configuration")
    print_json(data=r)
...
def update(
    ...
    r = client.put("api/v1/veracode/configuration", data=data)
    print_json(data=r)
...
def validate(ctx: typer.Context):
    ...
    """
    client = ctx.obj["client"]
    r = client.post("api/v1/veracode/configuration/validate")
    print_json(data=r)
...
def delete(ctx: typer.Context):
    ...
    """
    client = ctx.obj["client"]
    r = client.delete("api/v1/veracode/configurations")
    print_json(data=r)
