...
app = typer.Typer(help="Mend SAST commands", no_args_is_help=True)
...
def add(
    ...
    r = client.post("api/v1/mend/sast/configuration", data=data)
    print_json(data=r)
...
def get(ctx: typer.Context):
    ...
    """
    client = ctx.obj["client"]
    r = client.get("api/v1/mend/sast/default-configuration")
    print_json(data=r)
...
def update(
    ...
    r = client.put("api/v1/mend/sast/configuration", data=data)
    print_json(data=r)
...
def validate(ctx: typer.Context):
    ...
    """
    client = ctx.obj["client"]
    r = client.post("api/v1/mend/sast/configuration/validate")
    print_json(data=r)
...
def delete(ctx: typer.Context):
    ...
    """
    client = ctx.obj["client"]
    r = client.delete("api/v1/mend/sast/configurations")
    print_json(data=r)
