...
app = typer.Typer(help="PagerDuty commands", no_args_is_help=True)
...
def add(
    ...
    r = client.post("api/v1/pagerduty/configuration", data=data)
    print_json(data=r)
...
def delete(
    ...
    r = client.delete("api/v1/pagerduty/configuration/" + alias)
    print_json(data=r)
...
def delete_all(
    ...
    r = client.delete("api/v1/pagerduty/configurations")
    print_json(data=r)
...
def get(
    ...
    r = client.get("api/v1/pagerduty/configuration/" + alias)
    print_json(data=r)
...
def list(
    ...
    r = client.get("api/v1/pagerduty/configurations")
    print_json(data=r)
...
def get_default(
    ...
    r = client.get("api/v1/pagerduty/default-configuration")
    print_json(data=r)
...
def update(
    ...
    r = client.put("api/v1/pagerduty/configuration/" + alias, data=data)
    print_json(data=r)
