...
app = typer.Typer(help="SonarQube commands", no_args_is_help=True)
...
def add(
    ...
    r = client.post("api/v1/sonarqube/configuration", data=data)
    print_json(data=r)
...
def delete(
    ...
    r = client.delete("api/v1/sonarqube/configuration/" + alias)
    print_json(data=r)
...
def delete_all(
    ...
    r = client.delete("api/v1/sonarqube/configurations")
    print_json(data=r)
...
def get(
    ...
    r = client.get("api/v1/sonarqube/configuration/" + alias)
    print_json(data=r)
...
def list(
    ...
    r = client.get("api/v1/sonarqube/configurations")
    print_json(data=r)
...
def get_default(
    ...
    r = client.get("api/v1/sonarqube/default-configuration")
    print_json(data=r)
...
def update(
    ...
    r = client.put("api/v1/sonarqube/configuration/" + alias, data=data)
    print_json(data=r)
