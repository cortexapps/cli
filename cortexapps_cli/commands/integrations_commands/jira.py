...
app = typer.Typer(help="Jira commands", no_args_is_help=True)
...
def add(
    ...
    r = client.post("api/v1/jira/configuration", data=data)
    print_json(data=r)
...
def delete(
    ...
    r = client.delete("api/v1/jira/configuration/" + alias)
    print_json(data=r)
...
def delete_all(
    ...
    r = client.delete("api/v1/jira/configurations")
    print_json(data=r)
...
def get(
    ...
    r = client.get("api/v1/jira/configuration/" + alias)
    print_json(data=r)
...
def list(
    ...
    r = client.get("api/v1/jira/configurations")
    print_json(data=r)
...
def get_default(
    ...
    r = client.get("api/v1/jira/default-configuration")
    print_json(data=r)
...
def update(
    ...
    r = client.put("api/v1/jira/configuration/" + alias, data=data)
    print_json(data=r)
...
def validate(
    ...
    r = client.post("api/v1/jira/configuration/validate/" + alias)
    print_json(data=r)
...
def validate_all(
    ...
    r = client.post("api/v1/jira/configuration/validate")
    print_json(data=r)
