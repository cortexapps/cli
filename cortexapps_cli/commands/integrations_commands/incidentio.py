...
app = typer.Typer(help="IncidentIO commands", no_args_is_help=True)
...
def add(
    ...
    r = client.post("api/v1/incidentio/configuration", data=data)
    print_json(data=r)
...
def delete(
    ...
    r = client.delete("api/v1/incidentio/configuration/" + alias)
    print_json(data=r)
...
def delete_all(
    ...
    r = client.delete("api/v1/incidentio/configurations")
    print_json(data=r)
...
def get(
    ...
    r = client.get("api/v1/incidentio/configuration/" + alias)
    print_json(data=r)
...
def list(
    ...
    r = client.get("api/v1/incidentio/configurations")
    print_json(data=r)
...
def get_default(
    ...
    r = client.get("api/v1/incidentio/default-configuration")
    print_json(data=r)
...
def update(
    ...
    r = client.put("api/v1/incidentio/configuration/" + alias, data=data)
    print_json(data=r)
