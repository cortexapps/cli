...
app = typer.Typer(help="Jenkins commands", no_args_is_help=True)
...
def add(
    ...
    if file_input:
        if alias or api_key or host or is_default or username:
    ...
    r = client.post("api/v1/jenkins/configuration", data=data)
    print_json(data=r)
...
def delete(
    ...
    r = client.delete("api/v1/jenkins/configuration/" + alias)
    print_json(data=r)
...
def delete_all(
    ...
    r = client.delete("api/v1/jenkins/configurations")
    print_json(data=r)
...
def get(
    ...
    r = client.get("api/v1/jenkins/configuration/" + alias)
    print_json(data=r)
...
def list(
    ...
    r = client.get("api/v1/jenkins/configurations")
    print_json(data=r)
...
def get_default(
    ...
    r = client.get("api/v1/jenkins/default-configuration")
    print_json(data=r)
...
def update(
    ...
    r = client.put("api/v1/jenkins/configuration/" + alias, data=data)
    print_json(data=r)
...
def validate(
    ...
    r = client.post("api/v1/jenkins/configuration/validate/" + alias)
    print_json(data=r)
...
def validate_all(
    ...
    r = client.post("api/v1/jenkins/configuration/validate")
    print_json(data=r)
