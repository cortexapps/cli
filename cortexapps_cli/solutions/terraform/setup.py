...
class TerraformSetup(SolutionSetup):
    ...
    def post_steps(self) -> None:
        ...
        print("     Look for:")
        print("       ~ cortex_catalog_entity.phoenix              (update: terraform-demo-phoenix)")
        print("       + cortex_catalog_entity.notification_service (create: terraform-demo-notification-service)")
        print("       ~ cortex_catalog_entity.team_development     (update: terraform-demo-team-development)\n")
        print("  3. Apply:")
